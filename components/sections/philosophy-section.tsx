...
export function PhilosophySection() {
  ...
  return (
    <section id="features" className="bg-white">
              ...
              <div className="relative w-full" style={{ transformStyle: 'preserve-3d', minHeight: '150px' }}>
                {titles.map((title, index) => {
                  ...
                  return (
                    <h2 
                      key={index}
                      className="absolute inset-0 flex items-center justify-center text-[8vw] sm:text-[7vw] font-bold leading-tight tracking-tighter text-green-700 md:text-[6vw] lg:text-[5vw] text-center px-4"
                      style={{
      ...
      {/* Description */}
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36 bg-green-50">
        <div className="text-center">
          
          <p className="mt-8 leading-relaxed text-green-700 text-3xl text-center">
            {("Our AI tutoring platform learns your unique style and adjusts teaching methods to match. Every concept is explained at your pace, with real-time feedback and personalized challenges.").split(" ").map((word, index, array) => {
